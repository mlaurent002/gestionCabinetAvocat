...
import com.inti.service.impl.AppUtilisateurDetailsService;

@Configuration
@EnableWebSecurity
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	@Autowired
	private AppUtilisateurDetailsService appUtilisateurDetailsService; // Utilisateur + Profils
	@Autowired
	private BCryptPasswordEncoder bCryptPasswordEncoder;

	public void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(appUtilisateurDetailsService).passwordEncoder(bCryptPasswordEncoder);
	}

	// Activation : Formulaire d'authentification du projet Spring Security + la
	// méthode BAA
